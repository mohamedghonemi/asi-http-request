NOTE : This build to solve the optimization fail problem in release (using cocoapods to set the necessary compiler flags)
see https://stackoverflow.com/questions/9123975/asihttprequest-fails-in-production-builds for description of error.
